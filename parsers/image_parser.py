...
class Image_Parser(Parser):
    def opencv_preprocessing(self, img):
        """Preprocess the image using OpenCV for better text extraction"""
        ...
        # Apply morphological transformations to smooth the image
