...
def measure_similarity(sent1_words, sent2_words):
    """Implement the classic similarity function"""
...
def text_rank_algorithm(source_text):
    """Implement the classic Text Rank algorithm"""
    ...
    # Build a graph where each vertex is a sentence and
    # each edge measures the similarity between two sentences
    ...
    # Scale the weights so that the total weights of
    # all edges connected to any vertex is equal to 1
    for sent in sentences:
    ...
    # Attach the order of sentences in the source text
    final_result = []
